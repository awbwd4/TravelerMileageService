...
//    @NotEmpty
     ...
     **/
    //포인트 히스토리 생성
    public static PointHistory createPointHistory(int changedPoint, PointDiscriminator discriminator
...
//        pointHistory.setPoint(point);
    ...
    public static PointHistory createPointHistory(Point point, int changedPoint, PointDiscriminator discriminator
            , String userId, String placeId
            , boolean photo, boolean bonus) {
